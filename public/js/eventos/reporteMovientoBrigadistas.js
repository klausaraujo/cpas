function obtenerGrafica(URI, data) {
	try {
		$("#Mes").val(mes)
		initBar(jsonToArray(data.grafico), 'containerNivel');
		generateTable(JSON.parse(data.grafico), 'tbListarNivel')
		initBar(jsonToArray(data.graficoRegion), 'containerRegion');
		generateTable(JSON.parse(data.graficoRegion), 'tbListarRegion', 'Numero')
		initBar(jsonToArray(data.graficoRegionDos), 'containerRegionDos');
		generateTable(JSON.parse(data.graficoRegionDos), 'tbListarRegionDos', 'Numero')
