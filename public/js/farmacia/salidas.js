$(document).ready(function () {
  ...
  $('#tableArticuloModal').on('hidden.bs.modal', function () {
    ...
    $('#otrasactividadesdigerd').val(otrasactividadesdigerd);
  ...
  validate = $("#formRegistrarSalida").validate({
    rules: {
      anio: { required: true },
    ...
    submitHandler: function (form, event) {
      var formData = new FormData(document.getElementById("formRegistrarSalida"));
