function nuevo(URI) {
	function calculatetab1sec1() {
		...
		const hospitalizacion_camas_01 = Number($('#hospitalizacion_camas_01').val() || 0);
		const hospitalizacion_medicos_01 = Number($('#hospitalizacion_medicos_01').val() || 0);

		const hospitalizacion_camas_02 = Number($('#hospitalizacion_camas_02').val() || 0);
		const hospitalizacion_enfermeras_02 = Number($('#hospitalizacion_enfermeras_02').val() || 0);

		const emergencia_camas_01 = Number($('#emergencia_camas_01').val() || 0);
		const emergencia_medicos_01 = Number($('#emergencia_medicos_01').val() || 0);

		const emergencia_camas_02 = Number($('#emergencia_camas_02').val() || 0);
		const emergencia_enfermeras_02 = Number($('#emergencia_enfermeras_02').val() || 0);

		const criticos_camas_01 = Number($('#criticos_camas_01').val() || 0);
		const criticos_medicos_01 = Number($('#criticos_medicos_01').val() || 0);

		const criticos_camas_02 = Number($('#criticos_camas_02').val() || 0);
		const criticos_enfermeras_02 = Number($('#criticos_enfermeras_02').val() || 0);

		const pediatricos_camas_01 = Number($('#pediatricos_camas_01').val() || 0);
		const pediatricos_medicos_01 = Number($('#pediatricos_medicos_01').val() || 0);

		const pediatricos_camas_02 = Number($('#pediatricos_camas_02').val() || 0);
		const pediatricos_enfermeras_02 = Number($('#pediatricos_enfermeras_02').val() || 0);
		...
		$('#hospitalizacion_indicador_01').val(hospitalizacion_camas_01 / hospitalizacion_medicos_01);
		$('#hospitalizacion_indicador_02').val(hospitalizacion_camas_02 / hospitalizacion_enfermeras_02);

		$('#emergencia_indicador_01').val(emergencia_camas_01 / emergencia_medicos_01);
		$('#emergencia_indicador_02').val(emergencia_camas_02 / emergencia_enfermeras_02);

		$('#criticos_indicador_01').val(criticos_camas_01 / criticos_medicos_01);
		$('#criticos_indicador_02').val(criticos_camas_02 / criticos_enfermeras_02);

		$('#pediatricos_indicador_01').val(pediatricos_camas_01 / pediatricos_medicos_01);
		$('#pediatricos_indicador_02').val(pediatricos_camas_02 / pediatricos_enfermeras_02);
	};
	...
	function calculatetab2sec1() {
		...
		const emergencia_e_externa_02_h = Number($('#emergencia_e_externa_02_h').val() || 0);
		const emergencia_e_externa_02_u = Number($('#emergencia_e_externa_02_u').val() || 0);
		...
		const emergencia_e_externa_03_h = Number($('#emergencia_e_externa_03_h').val() || 0);
		const emergencia_e_externa_03_u = Number($('#emergencia_e_externa_03_u').val() || 0);
		...
		const emergencia_pacientes_01 = Number($('#emergencia_pacientes_01').val() || 0);
		const emergencia_pacientes_02 = Number($('#emergencia_pacientes_02').val() || 0);

		const emergencia_total_h = emergencia_convencionales_h + emergencia_covid_h + emergencia_e_externa_02_h + emergencia_e_interna_h + emergencia_e_externa_h + emergencia_e_externa_03_h;

		const emergencia_total_u = emergencia_convencionales_u + emergencia_covid_u + emergencia_e_externa_02_u + emergencia_e_interna_u + emergencia_e_externa_u + emergencia_e_externa_03_u + emergencia_pacientes_01 + emergencia_pacientes_02;
	...
	function calculatetab3sec1() {
		...
		const criticos_espera_u_momento = Number($('#criticos_espera_u_momento').val() || 0);
		const criticos_total_h = criticos_convencionales_h + criticos_covid_h + criticos_e_interna_h + criticos_e_externa_h;

		const criticos_total_u = criticos_convencionales_u + criticos_covid_u + criticos_e_interna_u + criticos_e_externa_u + criticos_espera_u + criticos_espera_u_momento;
	...
	function calculatetab4sec1() {
		...
		const pediatricos_paciente_01 = Number($('#pediatricos_paciente_01').val() || 0);
		...
		const pediatricos_total_u = pediatricos_convencionales_u + pediatricos_covid_u + pediatricos_e_interna_u + pediatricos_e_externa_u + pediatricos_espera_u + pediatricos_paciente_01;
	...
	$("#formHospital").validate({
		rules: {
			...
			emergencia_e_externa_02_h: { required: true },
			emergencia_e_externa_02_u: { required: true },
			...
			emergencia_e_externa_03_h: { required: true },
			emergencia_e_externa_03_u: { required: true },
			emergencia_e_externa_u: { required: true },
			emergencia_espera_u: { required: true },
			emergencia_pacientes_01: { required: true },
			emergencia_pacientes_02: { required: true },
			...
			criticos_espera_u_momento: { required: true },
			...
			pediatricos_paciente_01: { required: true },
		...
		messages: {
			...
			emergencia_e_externa_02_h: { required: "Campo requerido" },
			emergencia_e_externa_02_u: { required: "Campo requerido" },
			...
			emergencia_e_externa_03_h: { required: "Campo requerido" },
			emergencia_e_externa_03_u: { required: "Campo requerido" },
			emergencia_e_externa_u: { required: "Campo requerido" },
			emergencia_espera_u: { required: "Campo requerido" },
			emergencia_pacientes_01: { required: "Campo requerido" },
			emergencia_pacientes_02: { required: "Campo requerido" },
			...
			pediatricos_paciente_01: { required: "Campo requerido" },
	...
	$(document).ready(function () {
		...
		$("input[name=hospitalizacion_medicos_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=hospitalizacion_camas_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=hospitalizacion_camas_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=hospitalizacion_enfermeras_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=emergencia_camas_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=emergencia_medicos_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=emergencia_camas_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=emergencia_enfermeras_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=criticos_camas_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=criticos_medicos_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=criticos_camas_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=criticos_enfermeras_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=pediatricos_camas_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=pediatricos_medicos_01]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=pediatricos_camas_02]").on("keyup", function () { calculatetab1sec1(); });
		$("input[name=pediatricos_enfermeras_02]").on("keyup", function () { calculatetab1sec1(); });
		...
		$("input[name=emergencia_e_externa_02_h]").on("keyup", function () { calculatetab2sec1(); });
		$("input[name=emergencia_e_externa_02_u]").on("keyup", function () { calculatetab2sec1(); });
		...
		$("input[name=emergencia_e_externa_03_h]").on("keyup", function () { calculatetab2sec1(); });
		$("input[name=emergencia_e_externa_03_u]").on("keyup", function () { calculatetab2sec1(); });
		...
		$("input[name=emergencia_pacientes_01]").on("keyup", function () { calculatetab2sec1(); });
		$("input[name=emergencia_pacientes_02]").on("keyup", function () { calculatetab2sec1(); });
		...
		$("input[name=criticos_espera_u_momento]").on("keyup", function () { calculatetab3sec1(); });
		...
		$("input[name=pediatricos_paciente_01]").on("keyup", function () { calculatetab4sec1(); });
