...
<head>
  ...
  <?php $titulo = "Registrar de la ficha de evaluación de situación de los servicios de Emergencia"; ?>
</head>
...
<body>
                          ...
                          <form id="formHospital" name="formHospital" method="POST" action="" autocomplete="off">
                            ...
                            <!-- <div class="row">
                              ...
                              <div class="form-group row">
                                      ...
                                      <input id="dni_responsable_reporte" name="dni_responsable_reporte" class="form-control" type="text" />
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <input id="responsable_reporte" name="responsable_reporte"
                                    class="form-control text-uppercase" type="text" readonly/>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-5">CMP Responsable</label>
                                <div class="col-sm-7">
                                  <input id="cmp_responsable_reporte" name="cmp_responsable_reporte"
                                    class="form-control text-uppercase" type="text" />
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-5">RNE Responsable</label>
                                <div class="col-sm-7">
                                  <input id="rne_responsable_reporte" name="rne_responsable_reporte"
                                    class="form-control text-uppercase" type="text" />
                                </div>
                              </div>                              
                              ...
                              <div class="form-group row">
																	...
																	<div class="col-sm-7">
																		...
																		<div class="input-group" id="error_numero_documento">
                                											<input id="dni_jefe_guardia" name="dni_jefe_guardia" class="form-control" type="text" />
                                											<span class="input-group-btn">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <input id="jefe_guardia" name="jefe_guardia" class="form-control text-uppercase"
                                    type="text" readonly/>
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <input id="cmp_jefe_guardia" name="cmp_jefe_guardia" class="form-control text-uppercase"
                                    type="text" />
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <input id="rne_jefe_guardia" name="rne_jefe_guardia" class="form-control text-uppercase"
                                    type="text" />
                                </div>
                              </div>
                              <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group row">
                                    <div class="col-sm-9">
                                      <div class="input-group" id="error_numero_documento">
                                        <label class="col-sm-12">Nro. Documento:</label>
                                        <input id="dni_responsable_reporte" name="dni_responsable_reporte" class="form-control" type="text" />
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                      <div class="form-group">
                                        <div>
                                          <input type="text" class="form-control" name="telefono_responsable_reporte" id="telefono_responsable_reporte" /> 
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-xs-7">						
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                      <div class="form-group">
                                        <div>
                                          <input type="text" class="form-control" name="telefono_jefe_guardia" id="telefono_jefe_guardia" /> 
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_convencionales_h" id="hospitalizacion_convencionales_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_convencionales_u" id="hospitalizacion_convencionales_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_covid_h" id="hospitalizacion_covid_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_covid_u" id="hospitalizacion_covid_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_interna_h" id="hospitalizacion_e_interna_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_interna_u" id="hospitalizacion_e_interna_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_externa_h" id="hospitalizacion_e_externa_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_externa_u" id="hospitalizacion_e_externa_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="hospitalizacion_disponibles" id="hospitalizacion_disponibles" value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="hospitalizacion_total_h" id="hospitalizacion_total_h" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              ...
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_total_u" id="hospitalizacion_total_u" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_sospechosos_h_covid" id="hospitalizacion_sospechosos_h_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_sospechosos_u_covid" id="hospitalizacion_sospechosos_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_interna_h_covid" id="hospitalizacion_e_interna_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_interna_u_covid" id="hospitalizacion_e_interna_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_externa_h_covid" id="hospitalizacion_e_externa_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_e_externa_u_covid" id="hospitalizacion_e_externa_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="hospitalizacion_disponibles_covid" id="hospitalizacion_disponibles_covid" value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="hospitalizacion_total_h_covid" id="hospitalizacion_total_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="hospitalizacion_total_u_covid" id="hospitalizacion_total_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> Sobresaturación en Hospitalización </span>
                                              <div>  
                                                <input type="number" class="form-control" name="hospitalizacion_porcentaje_02" id="hospitalizacion_porcentaje_02" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_convencionales_h" id="emergencia_convencionales_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_convencionales_u" id="emergencia_convencionales_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_covid_h" id="emergencia_covid_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_covid_u" id="emergencia_covid_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_interna_h" id="emergencia_e_interna_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_interna_u" id="emergencia_e_interna_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_externa_h" id="emergencia_e_externa_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_externa_u" id="emergencia_e_externa_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_espera_u" id="emergencia_espera_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="emergencia_disponibles" id="emergencia_disponibles" value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="emergencia_total_h" id="emergencia_total_h" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_total_u" id="emergencia_total_u" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_sospechosos_h_covid" id="emergencia_sospechosos_h_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_sospechosos_u_covid" id="emergencia_sospechosos_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_interna_h_covid" id="emergencia_e_interna_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_interna_u_covid" id="emergencia_e_interna_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_externa_h_covid" id="emergencia_e_externa_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_e_externa_u_covid" id="emergencia_e_externa_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_espera_u_covid" id="emergencia_espera_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="emergencia_disponibles_covid" id="emergencia_disponibles_covid" value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="emergencia_total_h_covid" id="emergencia_total_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="emergencia_total_u_covid" id="emergencia_total_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> SOBRESATURACIÓN POR COVID DEL SERVICIO DE EMERGENCIA </span>
                                              <div>  
                                                <input type="number" class="form-control" name="emergencia_porcentaje_02" id="emergencia_porcentaje_02" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_convencionales_h" id="criticos_convencionales_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_convencionales_u" id="criticos_convencionales_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_covid_h" id="criticos_covid_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_covid_u" id="criticos_covid_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_interna_h" id="criticos_e_interna_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_interna_u" id="criticos_e_interna_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_externa_h" id="criticos_e_externa_h" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_externa_u" id="criticos_e_externa_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_espera_u" id="criticos_espera_u" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="criticos_disponibles" id="criticos_disponibles" value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="criticos_total_h" id="criticos_total_h" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="criticos_total_u" id="criticos_total_u" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_sospechosos_h_covid" id="criticos_sospechosos_h_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_sospechosos_u_covid" id="criticos_sospechosos_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_interna_h_covid" id="criticos_e_interna_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_interna_u_covid" id="criticos_e_interna_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_externa_h_covid" id="criticos_e_externa_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_e_externa_u_covid" id="criticos_e_externa_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="criticos_espera_u_covid" id="criticos_espera_u_covid"  value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-6">
                                                <div class="form-group" style="text-align: center;">
                                                  ...
                                                  <div>  
                                                    <input type="number" class="form-control" name="criticos_disponibles_covid" id="criticos_disponibles_covid"  value="0" readonly/> 
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="criticos_total_h_covid" id="criticos_total_h_covid"  value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="criticos_total_u_covid" id="criticos_total_u_covid"  value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> SOBRESATURACIÓN DE UCI ADULTOS COVID </span>
                                              <div>  
                                                <input type="number" class="form-control" name="criticos_porcentaje_02" id="criticos_porcentaje_02"  value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">                                      
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_sospechosos_h_covid" id="pediatricos_sospechosos_h_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group"  style="text-align: center;">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_sospechosos_u_covid" id="pediatricos_sospechosos_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_e_interna_h_covid" id="pediatricos_e_interna_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_e_interna_u_covid" id="pediatricos_e_interna_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_e_externa_h_covid" id="pediatricos_e_externa_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_e_externa_u_covid" id="pediatricos_e_externa_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_espera_u_covid" id="pediatricos_espera_u_covid" value="0" /> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-sm-12">						
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> HABILITADAS TOTALES </span>
                                              <div>  
                                                <input type="number" class="form-control" name="pediatricos_total_h_covid" id="pediatricos_total_h_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                              <span class="span__bold">HABILITADAS EN USO</span>
                                              <div>
                                                <input type="number" class="form-control" name="pediatricos_total_u_covid" id="pediatricos_total_u_covid" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            ...
                                            <span class="span__bold"> SOBRESATURACIÓN DE UCI PEDIATRICOS COVID </span>
                                              <div>  
                                                <input type="number" class="form-control" name="pediatricos_porcentaje_02" id="pediatricos_porcentaje_02" value="0" readonly/> 
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                              ...
                              <div class="tab-content">
                                <div id="nedocs" class="tab-pane fade in active">
                                  ...
                                  <div class="col-xs-12 col-sm-12">
                                              ...
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td><input type="text" class="form-control text-center" value="0"
                                                      id="nedocs_shock_trauma"
                                                      name="nedocs_shock_trauma">
                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><input type="text" class="form-control text-center" value="0"
                                                      id="nedocs_gineco_obstetricia"
                                                      name="nedocs_gineco_obstetricia">
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <th>TÓPICO PEDIATRIA</th>
                                                  <td><input type="text" class="form-control text-center" value="0"
                                                      id="nedocs_pedriatria"
                                                ...
                                                <tr>
                                                  ...
                                                  <td><input type="text" class="form-control text-center" value="0"
                                                      id="nedocs_observacion_cirugia"
                                                      name="nedocs_observacion_cirugia">
                                                  </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-xs-6">
                                      <fieldset
                                        style="display: block;margin-inline-start: 2px;margin-inline-end: 2px;padding-block-start: 0.35em;padding-inline-start: 0.75em;padding-inline-end: 0.75em;padding-block-end: 0.625em;min-inline-size: min-content;border-width: 2px;border-style: groove;border-color: threedface;border-image: initial;">
                                        <legend>Camas de Emergencia Ocupadas en Emergencias Masivas y Desastres</legend>
                                        <div>
                                          <div class="table-responsive">
                                            <table class="table">
                                              <thead>
                                            ...
                                            <table class="table">
                                              ...
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td><input type="text" class="form-control text-center" value="0.00"
                                            ...
                                            <table class="table">
                                              ...
                                              <tr>
                                                    ...
                                                    <td><input type="text" class="form-control text-center"
                                                        value="0" id="nedocs_resultado"
                                                        name="nedocs_resultado" readonly>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <th><button type="button" id="btn-calcular-ejemplo"
                                                      class="btn btn-primary">Cargar Ejemplo</button></th>
                                                  </tr>                                                  
                                              </tbody>
                                            </table>
                                          </div>
                                    ...
                                    <div class="col-xs-12" style="text-align: center;">
                                      <img id="NEDOCS" align='middle' src="<?=base_url()?>public/images/escala_nedocs.jpg" alt="imagen" title=''/>
                                    </div>  
                                  </div>
                                ...
                                <div id="emergencia" class="tab-pane fade in">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table">
                                      <thead>
                                      <caption style="text-align: center;font-weight: 900;font-size: x-large;">EMERGENCIA</caption>
                                        <tr>
                                          <th>AREAS</th>
                                      ...
                                      <tbody>
                                        <tr>
                                          <th>SHOCK TRAUMA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_shock_trauma" name="emergencia_camas_ogti_shock_trauma">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_shock_trauma" name="emergencia_camas_pasillos_shock_trauma">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_shock_trauma" name="emergencia_camas_contingencia_shock_trauma"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_shock_trauma" name="emergencia_camas_expansion_shock_trauma">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_shock_trauma" name="emergencia_camas_desastres_shock_trauma"></td>
                                        </tr>
                                        <tr>
                                          <th>MEDICINA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_medicina" name="emergencia_camas_pasillos_medicina">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_medicina" name="emergencia_camas_contingencia_medicina"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_medicina" name="emergencia_camas_expansion_medicina">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_medicina" name="emergencia_camas_desastres_medicina"></td>
                                        </tr>
                                        <tr>
                                          <th>CIRUGIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_cirugia" name="emergencia_camas_pasillos_cirugia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_cirugia" name="emergencia_camas_contingencia_cirugia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_cirugia" name="emergencia_camas_expansion_cirugia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_cirugia" name="emergencia_camas_desastres_cirugia"></td>
                                        </tr>
                                        <tr>
                                          <th>GINECO-OBSTETRICIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_gineco_obstetricia" name="emergencia_camas_ogti_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_gineco_obstetricia" name="emergencia_camas_pasillos_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_gineco_obstetricia" name="emergencia_camas_contingencia_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_gineco_obstetricia" name="emergencia_camas_expansion_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_gineco_obstetricia" name="emergencia_camas_desastres_gineco_obstetricia"></td>
                                        </tr>
                                        <tr>
                                          <th>PEDIATRIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_pedriatria" name="emergencia_camas_ogti_pedriatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_pedriatria" name="emergencia_camas_pasillos_pedriatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_pedriatria" name="emergencia_camas_contingencia_pedriatria"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_pedriatria" name="emergencia_camas_expansion_pedriatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_pedriatria" name="emergencia_camas_desastres_pedriatria"></td>
                                        </tr>
                                        <tr>
                                          <th>OBSERVACIÓN MEDICINA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_observacion_medicina" name="emergencia_camas_ogti_observacion_medicina">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_observacion_medicina" name="emergencia_camas_pasillos_observacion_medicina">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_observacion_medicina" name="emergencia_camas_contingencia_observacion_medicina"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_observacion_medicina" name="emergencia_camas_expansion_observacion_medicina">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_observacion_medicina" name="emergencia_camas_desastres_observacion_medicina"></td>
                                        </tr>
                                        <tr>
                                          <th>OBSERVACIÓN CIRUGIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_observacion_cirugia" name="emergencia_camas_ogti_observacion_cirugia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_observacion_cirugia" name="emergencia_camas_pasillos_observacion_cirugia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_observacion_cirugia" name="emergencia_camas_contingencia_observacion_cirugia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_observacion_cirugia" name="emergencia_camas_expansion_observacion_cirugia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_observacion_cirugia" name="emergencia_camas_desastres_observacion_cirugia"></td>
                                        </tr>
                                        <tr>
                                          <th>OBSERVACIÓN GINECO-OBSTETRICIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_observacion_gineco_obstetricia" name="emergencia_camas_ogti_observacion_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_observacion_gineco_obstetricia" name="emergencia_camas_pasillos_observacion_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_observacion_gineco_obstetricia" name="emergencia_camas_contingencia_observacion_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_observacion_gineco_obstetricia" name="emergencia_camas_expansion_observacion_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_observacion_gineco_obstetricia" name="emergencia_camas_desastres_observacion_gineco_obstetricia"></td>
                                        </tr>
                                        <tr>
                                          <th>OBSERVACIÓN PEDIATRIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_ogti_observacion_pediatria" name="emergencia_camas_ogti_observacion_pediatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_pasillos_observacion_pediatria" name="emergencia_camas_pasillos_observacion_pediatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_contingencia_observacion_pediatria" name="emergencia_camas_contingencia_observacion_pediatria"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_expansion_observacion_pediatria" name="emergencia_camas_expansion_observacion_pediatria">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="emergencia_camas_desastres_observacion_pediatria" name="emergencia_camas_desastres_observacion_pediatria"></td>
                                        </tr>                                        
                                      </tbody>
                                    </table>
                                  </div>
                                ...
                                <div id="pediatria" class="tab-pane fade in">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table">
                                      <thead>
                                      <caption style="text-align: center;font-weight: 900;font-size: x-large;">AREA PEDIATRICA</caption>
                                        <tr>
                                          <th>PEDIATRIA</th>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ogti_uci_pedriatrica" name="pedriatria_camas_ogti_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ocupadas_uci_pedriatrica" name="pedriatria_camas_ocupadas_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_pasillos_uci_pedriatrica" name="pedriatria_camas_pasillos_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_contigencia_uci_pedriatrica" name="pedriatria_camas_contigencia_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_expansion_uci_pedriatrica" name="pedriatria_camas_expansion_uci_pedriatrica"></td>
                                        </tr>
                                        <tr>
                                          <th>UCIN PEDIATRICA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ogti_ucin_pedriatrica" name="pedriatria_camas_ogti_ucin_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ocupadas_ucin_pedriatrica" name="pedriatria_camas_ocupadas_ucin_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_pasillos_ucin_pedriatrica" name="pedriatria_camas_pasillos_ucin_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_contigencia_ucin_pedriatrica" name="pedriatria_camas_contigencia_ucin_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_expansion_ucin_pedriatrica" name="pedriatria_camas_expansion_ucin_pedriatrica"></td>
                                        </tr>
                                        <tr>
                                          <th>UCI NEONATO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ogti_uci_neonato" name="pedriatria_camas_ogti_uci_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ocupadas_uci_neonato" name="pedriatria_camas_ocupadas_uci_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_pasillos_uci_neonato" name="pedriatria_camas_pasillos_uci_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_contigencia_uci_neonato" name="pedriatria_camas_contigencia_uci_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_expansion_uci_neonato" name="pedriatria_camas_expansion_uci_neonato"></td>
                                        </tr>
                                        <tr>
                                          <th>UCIN NEONATO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ogti_ucin_neonato" name="pedriatria_camas_ogti_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_ocupadas_ucin_neonato" name="pedriatria_camas_ocupadas_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_pasillos_ucin_neonato" name="pedriatria_camas_pasillos_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_contigencia_ucin_neonato" name="pedriatria_camas_contigencia_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="pedriatria_camas_expansion_ucin_neonato" name="pedriatria_camas_expansion_ucin_neonato"></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                                ...
                                <div id="ginecoobstetricia" class="tab-pane fade in">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table">
                                      <thead>
                                      <caption style="text-align: center;font-weight: 900;font-size: x-large;">UNIDAD DE CUIDADOS INTENSIVOS</caption>
                                        <tr>
                                          <th>GINECO-OBSTETRICIA</th>
                                          <th>CAMAS REGISTRADAS POR OGTI</th>
                                          <th>CAMAS OCUPADAS</th>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_ogti_uci" name="gineco_obstetricia_camas_ogti_uci"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_ocupadas_uci" name="gineco_obstetricia_camas_ocupadas_uci"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_pasillos_uci" name="gineco_obstetricia_camas_pasillos_uci"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_contingencia_uci" name="gineco_obstetricia_camas_contingencia_uci"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_expansion_uci" name="gineco_obstetricia_camas_expansion_uci"></td>
                                        </tr>
                                        <tr>
                                          <th>UCIN GINECO-OBSTETRICA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_ogti_ucin" name="gineco_obstetricia_camas_ogti_ucin"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_ocupadas_ucin" name="gineco_obstetricia_camas_ocupadas_ucin"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_pasillos_ucin" name="gineco_obstetricia_camas_pasillos_ucin"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_contingencia_ucin" name="gineco_obstetricia_camas_contingencia_ucin"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="gineco_obstetricia_camas_expansion_ucin" name="gineco_obstetricia_camas_expansion_ucin"></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                                ...
                                <div id="sop" class="tab-pane fade in">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table">
                                      <thead>
                                      <caption style="text-align: center;font-weight: 900;font-size: x-large;">SALA DE OPERACIONES</caption>
                                        <tr>
                                          <th>SOP</th>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_disponibles_gineco_obstetrica" name="sop_camas_disponibles_gineco_obstetrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_requeridos_gineco_obstetrica" name="sop_camas_requeridos_gineco_obstetrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_portatiles_gineco_obstetrica" name="sop_camas_portatiles_gineco_obstetrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_expansion_gineco_obstetrica" name="sop_camas_expansion_gineco_obstetrica"></td>
                                        </tr>
                                        <tr>
                                          <th>SOP EMERGENCIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_disponibles_emergencia" name="sop_camas_disponibles_emergencia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_requeridos_emergencia" name="sop_camas_requeridos_emergencia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_portatiles_emergencia" name="sop_camas_portatiles_emergencia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="sop_camas_expansion_emergencia" name="sop_camas_expansion_emergencia"></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                                      <div class="table-responsive">
                                        <table class="table">
                                          <thead>
                                          <caption style="text-align: center;font-weight: 900;font-size: x-large;">PERSONAL MEDICO</caption>
                                            <tr>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                                      <div class="table-responsive">
                                        <table class="table">
                                          <thead>
                                          <caption style="text-align: center;font-weight: 900;font-size: x-large;">OTROS PROFESIONALES Y TÉCNICOS DE SALUD</caption>
                                            <tr>
                                              <th>&nbsp;</th>
                                              <th>PROGRAMADO</th>
                                              <th>REQUERIDO</th>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                                      <div class="table-responsive">
                                        <table class="table">
                                          <thead>
                                          <caption style="text-align: center;font-weight: 900;font-size: x-large;">BANCO DE SANGRE</caption>
                                            <tr>
                                              <th>&nbsp;</th>
                                              <th>DISPONIBLE</th>
                                              <th>REQUERIDO</th>
                                ...
                                <div id="ventiladores" class="tab-pane fade in">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table">
                                      <thead>
                                      <caption style="text-align: center;font-weight: 900;font-size: x-large;"></caption>
                                        <tr>
                                          <th></th>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_trauma_shock_adulto" name="ventiladores_registrados_trauma_shock_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_trauma_shock_adulto" name="ventiladores_operativos_trauma_shock_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_trauma_shock_adulto" name="ventiladores_disponibles_trauma_shock_adulto"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_trauma_shock_adulto" name="ventiladores_alquilados_trauma_shock_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_trauma_shock_adulto" name="ventiladores_brecha_trauma_shock_adulto"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_trauma_shock_adulto" name="ventiladores_portatiles_trauma_shock_adulto"></td>      
                                        </tr>
                                        <tr>
                                          <th>TRAUMA SHOCK PEDIATRICO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_trauma_shock_pediatrico" name="ventiladores_registrados_trauma_shock_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_trauma_shock_pediatrico" name="ventiladores_operativos_trauma_shock_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_trauma_shock_pediatrico" name="ventiladores_disponibles_trauma_shock_pediatrico"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_trauma_shock_pediatrico" name="ventiladores_alquilados_trauma_shock_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_trauma_shock_pediatrico" name="ventiladores_brecha_trauma_shock_pediatrico"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_trauma_shock_pediatrico" name="ventiladores_portatiles_trauma_shock_pediatrico"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCI ADULTOS</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_uci_adultos" name="ventiladores_registrados_uci_adultos">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_uci_adultos" name="ventiladores_operativos_uci_adultos">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_uci_adultos" name="ventiladores_disponibles_uci_adultos"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_uci_adultos" name="ventiladores_alquilados_uci_adultos">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_uci_adultos" name="ventiladores_brecha_uci_adultos"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_uci_adultos" name="ventiladores_portatiles_uci_adultos"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCI PEDIATRICA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_uci_pedriatrica" name="ventiladores_registrados_uci_pedriatrica">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_uci_pedriatrica" name="ventiladores_operativos_uci_pedriatrica">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_uci_pedriatrica" name="ventiladores_disponibles_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_uci_pedriatrica" name="ventiladores_alquilados_uci_pedriatrica">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_uci_pedriatrica" name="ventiladores_brecha_uci_pedriatrica"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_uci_pedriatrica" name="ventiladores_portatiles_uci_pedriatrica"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCI NEONATOLOGIA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_uci_neonatologia" name="ventiladores_registrados_uci_neonatologia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_uci_neonatologia" name="ventiladores_operativos_uci_neonatologia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_uci_neonatologia" name="ventiladores_disponibles_uci_neonatologia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_uci_neonatologia" name="ventiladores_alquilados_uci_neonatologia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_uci_neonatologia" name="ventiladores_brecha_uci_neonatologia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_uci_neonatologia" name="ventiladores_portatiles_uci_neonatologia"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>SALA DE OPERACIONES</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_sala_operaciones" name="ventiladores_registrados_sala_operaciones">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_sala_operaciones" name="ventiladores_operativos_sala_operaciones">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_sala_operaciones" name="ventiladores_disponibles_sala_operaciones"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_sala_operaciones" name="ventiladores_alquilados_sala_operaciones">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_sala_operaciones" name="ventiladores_brecha_sala_operaciones"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_sala_operaciones" name="ventiladores_portatiles_sala_operaciones"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCIN ADULTO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_ucin_adulto" name="ventiladores_registrados_ucin_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_ucin_adulto" name="ventiladores_operativos_ucin_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_ucin_adulto" name="ventiladores_disponibles_ucin_adulto"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_ucin_adulto" name="ventiladores_alquilados_ucin_adulto">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_ucin_adulto" name="ventiladores_brecha_ucin_adulto"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_ucin_adulto" name="ventiladores_portatiles_ucin_adulto"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCIN PEDIATRICO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_ucin_pediatrico" name="ventiladores_registrados_ucin_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_ucin_pediatrico" name="ventiladores_operativos_ucin_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_ucin_pediatrico" name="ventiladores_disponibles_ucin_pediatrico"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_ucin_pediatrico" name="ventiladores_alquilados_ucin_pediatrico">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_ucin_pediatrico" name="ventiladores_brecha_ucin_pediatrico"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_ucin_pediatrico" name="ventiladores_portatiles_ucin_pediatrico"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCIN NEONATO</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_ucin_neonato" name="ventiladores_registrados_ucin_neonato">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_ucin_neonato" name="ventiladores_operativos_ucin_neonato">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_ucin_neonato" name="ventiladores_disponibles_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_ucin_neonato" name="ventiladores_alquilados_ucin_neonato">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_ucin_neonato" name="ventiladores_brecha_ucin_neonato"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_ucin_neonato" name="ventiladores_portatiles_ucin_neonato"></td>                                              
                                        </tr>
                                        <tr>
                                          <th>UCI GINECO-OBSTETRICA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_uci_gineco_obstetricia" name="ventiladores_registrados_uci_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_uci_gineco_obstetricia" name="ventiladores_operativos_uci_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_uci_gineco_obstetricia" name="ventiladores_disponibles_uci_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_uci_gineco_obstetricia" name="ventiladores_alquilados_uci_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_uci_gineco_obstetricia" name="ventiladores_brecha_uci_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_uci_gineco_obstetricia" name="ventiladores_portatiles_uci_gineco_obstetricia"></td>                                              
                                        </tr>  
                                        <tr>
                                          <th>UCIN GINECO-OBSTETRICA</th>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_registrados_ucin_gineco_obstetricia" name="ventiladores_registrados_ucin_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_operativos_ucin_gineco_obstetricia" name="ventiladores_operativos_ucin_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_disponibles_ucin_gineco_obstetricia" name="ventiladores_disponibles_ucin_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_alquilados_ucin_gineco_obstetricia" name="ventiladores_alquilados_ucin_gineco_obstetricia">
                                          </td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_brecha_ucin_gineco_obstetricia" name="ventiladores_brecha_ucin_gineco_obstetricia"></td>
                                          <td><input type="text" class="form-control text-center" value="0"
                                              id="ventiladores_portatiles_ucin_gineco_obstetricia" name="ventiladores_portatiles_ucin_gineco_obstetricia"></td>                                              
                                        </tr>                                        
                                      </tbody>
                                    </table>
                                  </div>
                                        ...
                                        <table class="table">
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_i_registradas" name="ambulancias_tipo_i_registradas">
                                              </td>
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_i_operaivas" name="ambulancias_tipo_i_operaivas">
                                              </td>
                                              <td><select class="form-control text-center"
                                                  id="ambulancias_tipo_i_radio"
                                            ...
                                            <tr>
                                              ...
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_ii_registradas"
                                                  name="ambulancias_tipo_ii_registradas"></td>
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_ii_operaivas"
                                                  name="ambulancias_tipo_ii_operaivas"></td>
                                              <td><select class="form-control text-center"
                                                  id="ambulancias_tipo_ii_radio"
                                            ...
                                            <tr>
                                              ...
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_iii_registradas"
                                                  name="ambulancias_tipo_iii_registradas"></td>
                                              <td><input type="text" class="form-control text-center" value="0"
                                                  id="ambulancias_tipo_iii_operaivas"
                                                  name="ambulancias_tipo_iii_operaivas"></td>
                                              <td><select class="form-control text-center"
                                                  id="ambulancias_tipo_iii_radio"
  ...
  <script src="<?=base_url()?>public/js/hospitales/nuevo.js?v=<?=date("his")?>"></script>
  <script>
    nuevo("<?=base_url()?>");
  </script>
