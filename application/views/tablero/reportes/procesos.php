...
<html lang="en">
	...
	$titulo="Reporte de Acciones Operativas (Tareas) Mensualizado";
	?>
...
<body>
            ...
            <div class="row heading-bg">
				...
				<div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
				  <ol class="breadcrumb">
					...
					<li class="active"><span>Reporte Tareas Mensualizado</span></li>
				  </ol>
				</div>
			</div>
				<div class="row">
											...
											<div class="row pa-10">
													<div class="col-xs-12 col-md-3 pa-10">
														<div class="form-group">
															<form id="formCambioFecha" action="<?=base_url()?>tablero/ReportesBasicos/procesos" method="POST">
    ...
    <script src="<?=base_url()?>public/js/tablero/procesos.js?v=<?=date("s")?>"></script>
    <script>
        var grafico1 = '<?=$grafico1?>';
        var grafico2 = '<?=$grafico2?>';
        Procesos("<?=base_url()?>",grafico1,grafico2);
</script>
</body>
</html>
