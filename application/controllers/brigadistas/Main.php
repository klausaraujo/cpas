...
class Main extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this
            ->session
            ->set_userdata("idmodulo", 2);

        ($this
            ->session
            ->userdata("idusuario")) ? $usuario = $this
            ->session
            ->userdata("idusuario") : redirect("login");
        ...
        if (sha1($usuario) == $token->usuario)
        {
            if (count($token->modulos) > 0)
            {
                ...
                foreach ($listaModulos as $row):
                    if ($row->idmodulo == 2 and $row->estado == 1)
                    {
                        $permanecer = true;
                    }
                endforeach;
    ...
    public function index()
    {
        ...
        $this
            ->load
            ->model("Brigadista_model");
        $this
            ->load
            ->model("EventoTipo_model");
        $this
            ->load
            ->model("Ubigeo_model");
        $this
            ->load
            ->model("AlertaPronostico_model");
        $tipo = $this
            ->EventoTipo_model
            ->lista();
        $funcion = $this
        ...
        $listaEventos = $this
            ...
            ->brigadistas_eventos();
        $listaralerta = $this
            ->AlertaPronostico_model
            ->listaralerta();
        $totalResumenRegistros = $this
            ->Brigadista_model
            ->totalResumenRegistros()
            ->row();
        $data = array(
            "tipo" => $tipo->result() ,
            "funcion" => $funcion->result() ,
    ...
    public function maincomisiones()
    {
        ...
        $anioPredeterminado = $this
            ->AnioEjecucion_model
            ->obtenerAnioPredeterminado();
        $listaAnioEjecucion = $this
            ->AnioEjecucion_model
            ->lista();
        $diresa = $this
            ->Brigadista_model
        ...
        $this
            ->load
            ->view("brigadistas/Maincomisiones", $data);
    }
    ...
    public function obtenerListaRenarhed()
    {
        $this
            ->load
            ->model("Brigadista_model");
        $listarComisionesRenarhed = $this
            ->Brigadista_model
            ->listarComisionesRenarhed();
        $detalle = array(
    ...
    public function listaEspecialidades()
    {
        ...
        $this
            ->Brigadista_model
            ->setBrigadistas_profesiones_id($id);
        $especialidades = $this
            ->Brigadista_model
            ->listaEspecialidades();

        echo json_encode(array(
            "especialidades" => $especialidades->result()
        ));
    ...
    public function profesiones()
    {
        ...
        $profesiones = $this
            ->Brigadista_model
            ->profesionesBrigadista();

        echo json_encode(array(
            "profesiones" => $profesiones->result()
        ));
    ...
    public function registrarEspecialidad()
    {
        ...
        $id = $this
            ->input
            ->post("id");
        $brigadistas_especialidad_id = $this
            ->input
            ->post("brigadistas_especialidad_id");
        ...
        $this
            ->Brigadista_model
            ->setBrigadistas_especialidad_id($brigadistas_especialidad_id);
    ...
    public function eliminarEspecialidad()
    {
        ...
        if ($this
            ->Brigadista_model
            ->eliminarEspecialidad() == 1)
        {
            $this
                ->session
                ->set_flashdata('messageOK', 'Registro eliminado');
        }
        else
        {
            $this
                ->session
                ->set_flashdata('messageError', 'No se puede eliminar');
        }
        redirect('brigadistas');
    }
    public function anucomisiones()
    {
        $this
            ->load
            ->model("Brigadista_model");
            ...
            ->anularcomision() == 1)
        {
            $this
                ->session
                ->set_flashdata('mensajeWarning', 'Registro Anulada con éxito.');
        }
        else
        {
            $this
                ->session
                ->set_flashdata('mensajeError', 'No se pudo Anular el Registro.');
        }
        header("location:" . base_url() . "brigadistas/comisiones");
    }
    ...
    public function registrar()
    {
        ...
        $nombres = $this
            ->input
            ->post("nombres");
        $Tipo_Documento_Codigo = $this
            ->input
            ->post("Tipo_Documento_Codigo");
        $Tipo_Documento_Codigo_C = $this
            ->input
            ->post("Tipo_Documento_Codigo_C");
        $documento_numero = $this
            ->input
            ->post("documento_numero");
        $genero = $this
            ->input
            ->post("genero");
        $fecha_nacimiento = $this
            ->input
        ...
        $pasaporte = $this
            ->input
            ->post("pasaporte");
        $caducidad_pasaporte = $this
            ->input
            ->post("caducidad_pasaporte");
        ...
        $email = $this
            ->input
            ->post("email");
        $email_institucional = $this
            ->input
            ->post("email_institucional");
        $Categoria = $this
            ->input
            ->post("Categoria");
        $observacion = $this
        ...
        $idinstitucion = $this
            ->input
            ->post("idinstitucion");
        $contacto_emergencia = $this
            ->input
            ->post("contacto_emergencia");
        $telefono_emergencia_01 = $this
            ->input
            ->post("telefono_emergencia_01");
        $telefono_emergencia_02 = $this
            ->input
            ->post("telefono_emergencia_02");
        $telefono_emergencia_03 = $this
            ->input
            ->post("telefono_emergencia_03");
        $parentesco = $this
            ->input
            ->post("parentesco");
        $apellidos_contacto = $this
            ->input
            ->post("apellidos_contacto");
        $nombres_contacto = $this
            ->input
            ->post("nombres_contacto");
        $grupo_sanguineo = $this
            ->input
            ->post("grupo_sanguineo");
        $talla = $this
            ->input
            ->post("talla");
        $imc = $this
        ...
        $brigadistas_banco_id = $this
            ->input
            ->post("brigadistas_banco_id");
        $ididioma = $this
            ->input
            ->post("ididioma");
        $numero_cuenta = $this
        ...
        $this
            ->Brigadista_model
            ->setTipo_Documento_Codigo($Tipo_Documento_Codigo);
        $this
            ->Brigadista_model
            ->setTipo_Documento_Codigo_C($Tipo_Documento_Codigo_C);
        $this
            ->Brigadista_model
            ->setDocumento_numero($documento_numero);
        $this
            ->Brigadista_model
            ->setGenero($genero);
        $this
        ...
        $this
            ->Brigadista_model
            ->setCaducidad_pasaporte($caducidad_pasaporte);
        $this
            ->Brigadista_model
        ...
        $this
            ->Brigadista_model
            ->setUbigeo_domicilio($ubigeo_domicilio);
        $this
            ->Brigadista_model
            ->setTelefono_01($telefono_01);
        $this
            ->Brigadista_model
            ->setTelefono_02($telefono_02);
        $this
            ->Brigadista_model
            ->setTelefono_03($telefono_03);
        $this
            ->Brigadista_model
            ->setEmail($email);
        $this
            ->Brigadista_model
            ->setEmail_institucional($email_institucional);
        $this
            ->Brigadista_model
            ->setContacto_emergencia($contacto_emergencia);
        $this
            ->Brigadista_model
            ->setTelefono_emergencia_01($telefono_emergencia_01);
        $this
            ->Brigadista_model
            ->setTelefono_emergencia_02($telefono_emergencia_02);
        $this
            ->Brigadista_model
            ->setTelefono_emergencia_03($telefono_emergencia_03);
        $this
            ->Brigadista_model
            ->setParentesco($parentesco);
        $this
            ->Brigadista_model
            ->setApellidos_contacto($apellidos_contacto);
        $this
            ->Brigadista_model
        ...
        $this
            ->Brigadista_model
            ->setBrigadistas_banco_id($brigadistas_banco_id);
        $this
            ->Brigadista_model
        ...
        $this
            ->Brigadista_model
            ->setNumero_cci($numero_cci);
        $count = $this
            ->Brigadista_model
            ->existe_renarhed();

        if (strlen($apellidos) < 1 or strlen($nombres) < 1 or strlen($Tipo_Documento_Codigo) < 1 or strlen($documento_numero) < 1 or strlen($genero) < 1 or strlen($fecha_nacimiento) < 1)
        {
            $data = array(
                "status" => 500
            );
        ...
        else
        {
            ...
            else
            {
                ...
                if ($id > 0)
                {
                    if ($verif_foto == 1)
                    {
                        $filename_foto = $this->agregarFotoReniec($foto_str);
                        $this
                            ->Brigadista_model
                            ->setIdrenarhed($id);
                        $this
                            ->Brigadista_model
                            ->setFoto_renarhed($filename_foto);
                        $this
                            ->Brigadista_model
                            ->agregarFotoRenarhed();
                    }
                    ...
                    {
                        $response_foto = $this->agregarFoto($foto);
                        if ($response_foto["estado"] == 0)
                        {
                            ...
                            $this
                                ->Brigadista_model
                                ->setFoto_renarhed($response_foto["foto"]);
                            $this
                                ->Brigadista_model
                                ->agregarFotoRenarhed();
                        }
    ...
    public function edicion()
    {
        ...
        $this
            ->Ubigeo_model
            ->setCodigo_Departamento(substr($brigadista->ubigeo_domicilio, 0, 2));
        $this
            ->Ubigeo_model
            ->setCodigo_Provincia(substr($brigadista->ubigeo_domicilio, 2, 2));
        $departamentos = $this
            ->Ubigeo_model
            ->departamentos();
        $provincias = $this
    ...
    public function editar()
    {
        ...
        if (strlen($id) < 1 or strlen($apellidos) < 1 or strlen($nombres) < 1 or strlen($Tipo_Documento_Codigo) < 1 or strlen($documento_numero) < 1 or strlen($genero) < 1 or strlen($fecha_nacimiento) < 1)
        {
            $data = array(
                "status" => 500
            );
        ...
        else
        {
                ...
                ->editarRenarhed())
            {
                ...
                if ($verif_foto > 0)
                {
                    if ($verif_foto == 1)
                    {
                        $filename_foto = $this->editarFotoReniec($foto_str, $enviar_imagen);
                        $this
                            ->Brigadista_model
                            ->setIdrenarhed($id);
                        $this
                    ...
                    else
                    {
                        ...
                        $foto = $_FILES["file"];
                        $response_foto = $this->editarFoto($id, $foto, $enviar_imagen);
                        if ($response_foto["estado"] == 0)
                        {
                            $this
                                ->Brigadista_model
    ...
    public function registrarCertificacion()
    {
        ...
        $id = $this
            ->input
            ->post("id");
        $tipo_certificacion = $this
            ->input
            ->post("tipo_certificacion");
        $fecha_reconocimiento = $this
            ->input
            ->post("fecha_reconocimiento");
        $resolucion = $this
            ->input
            ->post("resolucion");
        $fecha_inicio = $this
        ...
        $this
            ->Brigadista_model
            ->setTipo_certificacion($tipo_certificacion);
        $this
            ->Brigadista_model
            ->setFecha_reconocimiento(formatearFechaParaBD($fecha_reconocimiento));
        $this
            ->Brigadista_model
            ->setResolucion($resolucion);
        $this
            ->Brigadista_model
            ->setFecha_inicio(formatearFechaParaBD($fecha_inicio));
        $this
            ->Brigadista_model
            ->setFecha_vencimiento(formatearFechaParaBD($fecha_vencimiento));
    ...
    public function listaCapacitacion()
    {
        ...
        echo json_encode(array(
            "capacitaciones" => $capacitaciones->result()
        ));
    ...
    public function registrarCapacitacion()
    {
        ...
        $id = $this
            ->input
            ->post("id");
        $brigadistas_cursos_id = $this
            ->input
            ->post("brigadistas_cursos_id");
        $entidad = $this
            ->input
            ->post("entidad");
        $fecha_inicio = $this
        ...
        $this
            ->Brigadista_model
            ->setBrigadistas_cursos_id($brigadistas_cursos_id);
        $this
            ->Brigadista_model
            ->setEntidad($entidad);
        $this
        ...
        $this
            ->Brigadista_model
            ->setFecha_fin(formatearFechaParaBD($fecha_fin));
        $this
            ->Brigadista_model
            ->setHoras($horas);
    ...
    public function registrarEmergencia()
    {
        ...
        $calificacion = $this
            ->input
            ->post("calificacion");
        $acciones_realizadas = $this
            ->input
            ->post("acciones_realizadas");
        $idevento = $this
            ->input
            ->post("idevento");
        ...
        $this
            ->Brigadista_model
            ->setFuerza_tarea($fuerza_tarea);
        $this
            ->Brigadista_model
            ->setCalificacion($calificacion);
        $this
            ->Brigadista_model
            ->setAcciones_realizadas($acciones_realizadas);
        $this
            ->Brigadista_model
            ->setEvento_Registro_Numero($idevento);
    ...
    public function listaContingencias()
    {
        ...
        echo json_encode(array(
            "contingencias" => $contingencias->result()
        ));
    ...
    public function registrarTrabajo()
    {
        ...
        $oficina = $this
            ->input
            ->post("oficina");
        $condicion_laboral = $this
            ->input
            ->post("condicion_laboral");
        $cargo = $this
            ->input
            ->post("cargo");
        $telefono_institucional = $this
            ->input
            ->post("telefono_institucional");
        $email_institucional = $this
            ->input
            ->post("email_institucional");
        ...
        $this
            ->Brigadista_model
            ->setcondicion_laboral($condicion_laboral);
        $this
            ->Brigadista_model
            ->setcargo($cargo);
        $this
            ->Brigadista_model
            ->settelefono_institucional($telefono_institucional);
        $this
            ->Brigadista_model
            ->setemail_institucional($email_institucional);
    ...
    public function cargarProvincias()
    {
        ...
        $this
            ->Ubigeo_model
            ->setCodigo_Departamento($departamento);
    ...
    public function eventosAjax()
    {
        ...
        if (strlen($evento_tipo) > 0 and strlen($evento_fecha) > 9)
        {
            ...
            $this
                ->EventoRegistrar_model
                ->setTipoEvento($evento_tipo);
            $this
                ->EventoRegistrar_model
                ->setFechaEvento(formatearFechaParaBD($evento_fecha));
            ...
            if ($lista->num_rows() > 0)
            {
                foreach ($lista->result() as $row):
                    ...
                    {
                        case 1:
                            $estado = '<span class="label label-success">Monitoreo</span>';
                        break;
                        case 2:
    ...
    public function ficha()
    {
        ...
        $html = $this
            ->load
            ->view("brigadistas/ficha", $data, true);
        $this
            ->pdf
            ->html2Pdf("P", "A4", $html, "Ficha Brigadista");
    ...
    public function fotocheck()
    {
        ...
        $this
            ->Brigadista_model
            ->setbrigadistas_profesiones_id($carnet->brigadistas_profesion_id);
        $this
            ->Brigadista_model
            ->setbrigadistas_especialidad_id($carnet->brigadistas_especialidad_id);
        $profesionEspecialidad = $this
            ->Brigadista_model
            ->profesionEspecialidad();
        $profesionEspecialidad = $profesionEspecialidad->row();
        $this
            ->Brigadista_model
            ->setId($carnet->brigadista_id);
        $trabajo = $this
            ->Brigadista_model
            ->ultimotrabajo();
        ...
        $fileName = $this
            ->qrgenerator
            ->generate($carnet->documento_numero, $code, $path, $size);
        ...
        $html = $this
            ->load
            ->view("brigadistas/fotocheck", $data, true);
        $this
            ->dom
            ->generate("portrait", "carnet", $html, "Fotocheck Brigadista");
    ...
    private function tipoCategoria($code)
    {
        ...
        {
            case "1":
                $categoria = "EQUIPO T&Eacute;CNICO";
            break;
            case "2":
                $categoria = "BRIGADISTA";
            break;
            case "3":
                $categoria = "EQUIPO M&Eacute;DICO DE EMERGENCIA";
            break;
            case "4":
                $categoria = "BRIGADISTA / EMT";
            break;
        }
        return $categoria;
    }
    ...
    public function profesionesBrigadistaAjax()
    {
        ...
        echo json_encode(array(
            "profesiones" => $profesiones->result() ,
            "certificaciones" => $certificaciones->result()
        ));
    }
    ...
    public function especialidadesProfesionesBrigadistaAjax()
    {
        ...
        $id = $this
            ->input
            ->post("id");
        $brigadistas_profesiones_id = $this
            ->input
            ->post("brigadistas_profesiones_id");
        ...
        $this
            ->Brigadista_model
            ->setBrigadistas_profesiones_id($brigadistas_profesiones_id);
        $especialidades = $this
            ->Brigadista_model
            ->especialidadesProfesionesBrigadista();
    ...
    public function registrarFotocheck()
    {
        ...
        $fecha_vencimiento = $this
            ->input
            ->post("fecha_vencimiento");
        $brigadistas_certificacion_id = $this
            ->input
            ->post("brigadistas_certificacion_id");
        $status = 500;
        $this
            ->Brigadista_model
            ->setId($id);
        ...
        $this
            ->Brigadista_model
            ->setFecha_inicio(formatearFechaParaBD($fecha_emision));
        $this
            ->Brigadista_model
            ->setFecha_vencimiento(formatearFechaParaBD($fecha_vencimiento));
        $this
            ->Brigadista_model
            ->setbrigadistas_certificacion_id($brigadistas_certificacion_id);
        $find = $this
            ->Brigadista_model
            ->existeFotocheck();
        if ($find->num_rows() > 0)
    ...
    public function registrarSede()
    {
        ...
        $idBrigadista = $this
            ->input
            ->post("id");
        $brigadistas_evento_id = $this
            ->input
            ->post("brigadistas_evento_id");
        $brigadistas_clusters_id = $this
            ->input
            ->post("brigadistas_clusters_id");
        $brigadistas_sedes_id = $this
            ->input
            ->post("brigadistas_sedes_id");
        $status = 500;
        ...
        $this
            ->Brigadista_model
            ->setbrigadistas_evento_id($brigadistas_evento_id);
        $this
            ->Brigadista_model
            ->setbrigadistas_clusters_id($brigadistas_clusters_id);
        $this
            ->Brigadista_model
            ->setbrigadistas_sedes_id($brigadistas_sedes_id);
    ...
    public function formNew()
    {
        ...
        $this
            ->load
            ->view("brigadistas/form-new", $data);
    ...
    public function formAdditional()
    {
        ...
        $this
            ->load
            ->view("brigadistas/form-additional", $data);
    }
    ...
    public function registrarIdioma()
    {
        ...
        $this
            ->Brigadista_model
            ->setLectura($lectura == "on" ? "1" : "0");
        $this
            ->Brigadista_model
            ->setEscritura($escritura == "on" ? "1" : "0");
    ...
    public function registrarCarrera()
    {
        ...
        if ($id > 0)
        {
            ...
            if ($response["status"])
            {
                ...
                $this
                    ->Brigadista_model
                    ->setArchivo_titulo($response["file_titulo"]);
                $this
                    ->Brigadista_model
                    ->setArchivo_especialidad($response["file_especialidad"]);
                $this
                    ->Brigadista_model
                    ->agregarFileCarreras();
            }
    ...
    public function registrarCertificado()
    {
        ...
        $idrenarhed = $this
            ->input
            ->post("id");
        $idcertificacion = $this
            ->input
            ->post("idcertificacion");
        $idinstitucion = $this
            ->input
            ->post("idinstitucion");
        $fecha_inicio = $this
        ...
        $this
            ->Brigadista_model
            ->setIdcertificacion($idcertificacion);
        $this
            ->Brigadista_model
            ->setIdinstitucion($idinstitucion);
        $this
        ...
        $this
            ->Brigadista_model
            ->setFecha_vigencia($fecha_vigencia);
        ...
        if ($id > 0)
        {
            ...
            if ($response["status"])
            {
                $this
                    ->Brigadista_model
                    ->setArchivo_adjunto($response["file_certificado"]);
                $this
                    ->Brigadista_model
                    ->agregarFileCertificaciones();
            }
            $status = 200;
        }
        echo json_encode(array(
    ...
    public function registrarLaboral()
    {
        ...
        $codigo_institucion = $this
            ->input
            ->post("codigo_institucion");
        $codigo_region = $this
            ->input
            ->post("codigo_region");
        $codigo_disa = $this
        ...
        $codigo_red = $this
            ->input
            ->post("codigo_red");
        $codigo_micro_red = $this
            ->input
            ->post("codigo_micro_red");
        $codigo_renipress = $this
            ->input
            ->post("codigo_renipress");
        $codigo_condicion = $this
            ->input
            ->post("codigo_condicion");
        $status = 500;
        $this
            ->Brigadista_model
            ->setIdRenarhed($idrenarhed);
        $this
            ->Brigadista_model
            ->setCodigo_institucion($codigo_institucion);
        $this
            ->Brigadista_model
            ->setCodigo_region($codigo_region);
        $this
            ->Brigadista_model
            ->setCodigo_disa($codigo_disa);
        $this
            ->Brigadista_model
            ->setCodigo_red($codigo_red);
        $this
            ->Brigadista_model
            ->setCodigo_micro_red($codigo_micro_red);
        $this
            ->Brigadista_model
            ->setCodigo_renipress($codigo_renipress);
        $this
            ->Brigadista_model
            ->setCodigo_condicion($codigo_condicion);
        $id = 0;
        $id = $this
            ->Brigadista_model
            ->registrarLaboral();
    ...
    public function registrarCapacitacionPersonal()
    {
        ...
        $idrenarhed = $this
            ->input
            ->post("id");
        $tipo_capacitacion = $this
            ->input
            ->post("tipo_capacitacion");
        $nombre = $this
            ->input
            ->post("nombre");
        $institucion = $this
        ...
        $this
            ->Brigadista_model
            ->setTipo_capacitacion($tipo_capacitacion);
        $this
            ->Brigadista_model
            ->setNombre($nombre);
        $this
        ...
        $this
            ->Brigadista_model
            ->setFecha_emision($fecha_emision);
        $id = 0;
        $id = $this
            ->Brigadista_model
            ->registrarCapacitacionPersonal();
        ...
        if ($id > 0)
        {
            ...
            if ($response["status"])
            {
                ...
                $this
                    ->Brigadista_model
                    ->setArchivo_adjunto($response["file_capacitacion"]);
                $this
                    ->Brigadista_model
                    ->agregarFileCapacitaciones();
            }
            $status = 200;
        } 
        echo json_encode(array(
    ...
    public function registrarInmunizacionPersonal()
    {
        ...
        $idrenarhed = $this
            ->input
            ->post("id");
        $tipo_inmunizacion = $this
            ->input
            ->post("tipo_inmunizacion");
        $nombre = $this
            ->input
            ->post("nombre");
        $numero_dosis = $this
        ...
        $this
            ->Brigadista_model
            ->setTipo_inmunizacion($tipo_inmunizacion);
        $this
            ->Brigadista_model
            ->setNombre($nombre);
        $this
            ->Brigadista_model
            ->setNumero_dosis($numero_dosis);
        $this
            ->Brigadista_model
            ->setFecha_vacuna($fecha_vacuna);

        $id = 0;

        $id = $this
            ->Brigadista_model
            ->registrarInmunizacionPersonal();
        ...
        if ($id > 0)
        {
            ...
            if ($response["status"])
            {
                $this
                    ->Brigadista_model
                    ->setIdinmunizacion($id);
                $this
                    ->Brigadista_model
                    ->setArchivo_adjunto($response["file_inmunizacion"]);
                $this
                    ->Brigadista_model
                    ->agregarFileInmunizaciones();
            }
            $status = 200;
        }
        echo json_encode(array(
    ...
    public function registrarAlergiaPersonal()
    {
        ...
        $alergias_alimentarias = $this
            ->input
            ->post("alergias_alimentarias");
        $alergias_farmacologicas = $this
            ->input
            ->post("alergias_farmacologicas");
        ...
        $this
            ->Brigadista_model
            ->setAlergias_alimentarias($alergias_alimentarias);
        $this
            ->Brigadista_model
            ->setAlergias_farmacologicas($alergias_farmacologicas);

        $id = 0;
        $id = $this
            ->Brigadista_model
            ->registrarAlergiaPersonal();
        ...
        if ($id > 0)
        {
            ...
            if ($response["status"])
            {
                $this
                    ->Brigadista_model
                    ->setTarjeta_vacunas($response["file_vacunacion"]);
                $this
                    ->Brigadista_model
                    ->agregarFileVacunaciones();
            }
            $status = 200;
        }
        echo json_encode(array(
    ...
    public function formEdit()
    {
        ...
        $this
            ->load
            ->view("brigadistas/form-edit", $data);
    ...
    public function editarFotoReniec($foto_str, $imagen_old)
    {
        ...
        if (file_exists($path . $imagen_old)) unlink($path . $imagen_old);
        $image = base64_decode($foto_str);
        $image_name = date("Ymdhis");
        $filename = $image_name . '.' . 'jpg';
        $path = getenv('PATH_IMG_BRIGADISTA');
    ...
    public function cargarListaIdiomasAjax($idget = "")
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id);
        $listaIdiomasPersonal = $this
            ->Brigadista_model
            ->listarIdiomasPersonal();
    ...
    public function cargarListaCarrerasAjax($idget = "")
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id);
        $listaCarrerasPersonal = $this
            ->Brigadista_model
            ->listarCarrerasPersonal();
    ...
    public function cargarListaCertificacionAjax($idget = "")
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id);
        $listaCertificadoPersonal = $this
            ->Brigadista_model
            ->listarCertificadoPersonal();
    ...
    public function cargarListaInmunizacionAjax($idget = "")
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id);
        $listaInmunizacionPersonal = $this
            ->Brigadista_model
            ->listarInmunizacionPersonal();
    ...
    public function cargarListaCapacitacionAjax($idget = "")
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id);
        $listaCapacitacionPersonal = $this
            ->Brigadista_model
            ->listarCapacitacionPersonal();
    ...
    public function getEspecialidadesxProfesion()
    {
        ...
        $this
            ->Brigadista_model
            ->setIdrenarhed($id_profesion);
        $listaEspecialidades = $this
            ->Brigadista_model
            ->getEspecialidadesxProfesion();
    ...
    public function eliminarFileCarrera()
    {
        $this
            ->load
            ->model("EventoRegistroFile_model");
        $id = $this
            ->input
            ->post("Evento_Registro_File_Numero");
        $Evento_Registro_Numero = $this
            ->input
            ->post("Evento_Registro_Numero");
        $files = $this
            ->input
            ->post("files");
        $path = getenv('PATH_DOC_CERTIFICADO');
        if (file_exists($path . $files)) unlink($path . $files);
        $this
            ->EventoRegistroFile_model
            ->setId($id);
        $this
            ->EventoRegistroFile_model
            ->eliminar();
    ...
    public function eliminarCapacitacionPersonal()
    {
        ...
        if ($this
            ->Brigadista_model
            ->eliminarCapacitacionPersonal() == 1)
        {
            $status = 200;
            $msg = "Registro eliminado";
    ...
    public function eliminarInmunizacionPersonal()
    {
        ...
        if ($this
            ->Brigadista_model
            ->eliminarInmunizacionPersonal() == 1)
        {
            $status = 200;
            $msg = "Registro eliminado";
    ...
    public function guardarComision()
    {
        ...
        $tipocomision = $this
            ->input
            ->post("tipo");
        $tipoEventocomision = $this
            ->input
            ->post("tipoEvento");
        $eventocomision = $this
            ->input
            ->post("evento");
        $eventoDetallecomision = $this
            ->input
            ->post("eventoDetalle");
        $numeroEventocomision = $this
            ->input
            ->post("idEvento");
        $descripcioncomision = $this
            ->input
            ->post("descripcion");
        $fechaIniciocomision = $this
            ->input
            ->post("fechaInicio");
        $fechaFincomision = $this
            ->input
            ->post("fechaFin");
        ...
        $this
            ->Brigadista_model
            ->setRegionComision($regioncomision);
        $this
            ->Brigadista_model
            ->setTipoComision($tipocomision);
        $this
            ->Brigadista_model
            ->setTipoEventoComision($tipoEventocomision);
        $this
            ->Brigadista_model
            ->setEventoComision($eventocomision);
        $this
            ->Brigadista_model
            ->setEventoDetalleComision($eventoDetallecomision);
        $this
            ->Brigadista_model
            ->setNumeroEventoComision($numeroEventocomision);
        $this
            ->Brigadista_model
            ->setDescripcionComision($descripcioncomision);
        $this
            ->Brigadista_model
            ->setFechaInicioComision($fechaIniciocomision . ' ' . '00:00:00');
        $this
            ->Brigadista_model
            ->setFechaFinComision($fechaFincomision . ' ' . '00:00:00');
        $this
            ->Brigadista_model
            ->setAnioComision($aniocomision);
        $this
            ->Brigadista_model
            ->setMesComision($mescomision);
        $idrenarhed = $this
            ->input
            ->post("idrenarhed");
        $apellidos = $this
        ...
        if ($archivo != false)
        {
            $this
                ->Brigadista_model
                ->setFichaTecnicaComision($archivo);
        }
        if ($idcomision > 0)
        {
            if ($this
                ...
                ->actualizarComision())
            {
                $respuestaEliminar = $this
                    ->Brigadista_model
                    ->eliminarDetalleComision();
                if ($respuestaEliminar && $this->guardarDetalleComision($idcomision, $idrenarhed, $apellidos, $nombres, $numero_documento, $funcion))
                {
                    $status = 200;
        ...
        else
        {
            ...
            if ($idcomision)
            {
                if ($this->guardarDetalleComision($idcomision, $idrenarhed, $apellidos, $nombres, $numero_documento, $funcion))
                {
                    $status = 200;
    ...
    public function guardarDetalleComision($idcomision, $idrenarhed, $apellidos, $nombres, $numero_documento, $funcion)
    {
        $this
            ->Brigadista_model
            ->setIdcomision($idcomision);
        $idrenarhed = explode("|", $idrenarhed);
        $apellidos = explode("|", $apellidos);
        $nombres = explode("|", $nombres);
        $numero_documento = explode("|", $numero_documento);
        $funcion = explode("|", $funcion);

        foreach ($idrenarhed as $key => $id):
            $this
                ->Brigadista_model
                ->setIdrenarhedcomi($id);
            $this
                ->Brigadista_model
                ->setApellidoscomi($apellidos[$key]);
            $this
                ->Brigadista_model
                ->setNombrescomi($nombres[$key]);
            $this
                ->Brigadista_model
                ->setNro_Documentocomi($numero_documento[$key]);
            $this
                ->Brigadista_model
                ->setFuncioncomi($funcion[$key]);
            $this
                ->Brigadista_model
    ...
    public function obtenerDetalleComision()
    {
        ...
        $listacomi = $this
            ->Brigadista_model
            ->obtenerDetalleListaComisiones();
        $detalle = array(
            "listacomi" => $listacomi->num_rows() ? $listacomi->result() : array()
        );
        $data = array(
            "status" => 200,
            "data" => $detalle
