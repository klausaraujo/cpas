...
class Fichas extends CI_Controller
{
	...
	public function lista()
    {
      ...
      $Evento_Registro_Numero = base64_decode($this->uri->segment(4, 0));
      
      if(strlen($Evento_Registro_Numero)==0) header("location:" . base_url() . "ofertamovil/eventos/lista/".base64_encode($Evento_Registro_Numero));
      ...
      $paises = $rsPaises->result();
        ...
        $this->load->view("ofertamovil/listaFichas", $data);
    }
    ...
    public function registrar(){
        ...
        header("location:" . base_url() . "ofertamovil/fichas/lista/".base64_encode($Evento_Registro_Numero));
    ...
    public function editar(){
        ...
        header("location:" . base_url() . "ofertamovil/fichas/lista");
    ...
    public function abrir(){
        ...
        $Evento_Registro_Numero = base64_decode($this->uri->segment(4, 0));
        $id = base64_decode($this->uri->segment(5, 0));
    ...
    public function consolidado(){
        ...
        if(strlen($Evento_Registro_Numero)==0 || strlen($id)==0) header("location:" . base_url() . "ofertamovil/fichas/lista/".base64_encode($Evento_Registro_Numero));
        ...
        $this->load->view("ofertamovil/fichaConsolidado",$data);
    ...
    public function editarAtencion(){
        ...
        $this->session->set_flashdata('Evento_Registro_Numero', $Evento_Registro_Numero);
        header("location:" . base_url() . "ofertamovil/fichas/consolidado/".base64_encode($Evento_Registro_Numero));
    ...
    public function reportarFicha() {
        ...
        return $this->load->view("ofertamovil/reportarFicha",$data);
